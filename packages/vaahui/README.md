...
- In the root folder of your client app, run `npm link vaahui`. This will add the symbolic link to the `node_modules` folder in your client app.
- You can now import `vaahui` in your client app.

There is no need to add `vaahui` to your client app's dependency in this case.
