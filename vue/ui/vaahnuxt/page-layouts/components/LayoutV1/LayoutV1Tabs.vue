        ...
        <div class="columns">
          <div class="column is-12">
            <div class="columns is-flex-mobile">
              ...
              <div class="column is-half-mobile is-half-width has-text-right">
                <button class="button is-success is-capitalized">
                  new project
                </button>
              </div>
            </div>
        ...
        <div class="columns">
          <div class="column is-12">
            <b-tabs>
              ...
              <b-tab-item label="Your Projects 14">
                <b-tabs>
                    ...
                    <div class="items">
                      <div class="columns">
                        ...
                        <div class="column is-6">
                          <div class="columns">
                            <div class="column is-6">
                              <ul class="has-padding-left-50-mobile">
                            ...
                            <div class="column is-6 is-hidden-mobile">
                              <p class="is-capitalized">updated feb 12, 2020</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <b-tab-item label="Starred Proects 0">
                <b-tabs>
                  <b-tab-item label="All">
              ...
              <b-tab-item label="Explore Projects">
                <b-tabs>
                  <b-tab-item label="All">
