...
This setup assumes your client app is created with Vite and vue-ts template, and you use 'npm link' to link to `vaahui` locally.
...
<script setup lang="ts">
  import { ComponentA, ComponentB } from 'vaahui';
</script>
```
